...
describe('getPrototypeChain', () => {
  ...
  it('User-defined classes', () => {
    ...
    expect(getPrototypeChain(new Rhino())).toEqual(['Rhino', 'Mammal', 'Object']);
  })
})
...
describe('defgeneric', () => {
  ...
  it('example 2', () => {
    ...
    expect(laysEggs.bind(null, 5)).toThrow('No method found for laysEggs with args: number');
  })
  ...
  it('before & after', () => {
    ...
    var laysEggs = defgeneric('laysEggs')
      .defmethod('Mammal', function () { return false; })
      .defmethod('Platypus', function () { return true; })
      .defmethod('Platypus', function () { lines.push('Before platypus egg check.'); }, 'before')
      .defmethod('Mammal', function () { lines.push('Before mammal egg check.'); }, 'before')
      .defmethod('*', function () { lines.push('Before egg check.'); }, 'before')
      .defmethod('Platypus', function () { lines.push ('After platypus egg check.'); }, 'after')
      .defmethod('Mammal', function () { lines.push('After mammal egg check.'); }, 'after');
  ...
  it('callNextMethod & around', () => {
    ...
    var laysEggs = defgeneric('laysEggs')
      ...
      .defmethod('Platypus', function () { return true; });
    laysEggs
      .defmethod('Platypus', function () { logs.push('Before platypus egg check.'); }, 'before')
      .defmethod('Mammal', function () { logs.push('Before mammal egg check.'); }, 'before')
      .defmethod('*', function () { logs.push('Before egg check.'); }, 'before')
      .defmethod('Platypus', function () { logs.push ('After platypus egg check.'); }, 'after')
      .defmethod('Mammal', function () { logs.push('After mammal egg check.'); }, 'after');
